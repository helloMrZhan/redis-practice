package com.zjq.restaurants.service;

import cn.hutool.core.bean.BeanUtil;
import com.google.common.collect.Maps;
import com.zjq.commons.constant.RedisKeyConstant;
import com.zjq.commons.model.pojo.Restaurant;
import com.zjq.restaurants.RestaurantApplicationTest;
import com.zjq.restaurants.mapper.RestaurantMapper;
...
public class RestaurantTest extends RestaurantApplicationTest {
    ...
    void testSyncForHash() {
        ...
        log.info("执行时间：{} ms", end - start); // 执行时间：50953 ms
    }
    ...
    void testSyncForHashPipeline() {
        ...
        long end = System.currentTimeMillis();
        log.info("执行时间：{} ms", end - start); // 执行时间：32016 ms
    }
