...
public class NearMeService {
     ...
     * @param lat         纬度
     */
    public void saveOrUpdateUserLocation(String accessToken, Float lon, Float lat) {
        // 参数校验
     ...
     * @return
     */
    public List<NearMeUserVO> findNearMe(String accessToken,
                                         Integer radius,
                                         Float lon, Float lat) {
        // 获取登录用户信息
        SignInUserInfo signInUserInfo = loadSignInUserInfo(accessToken);
        ...
        List<ShortUserInfo> shortUserInfos = usersService.findByIds(StrUtil.join(",", userIds));
        // 完善昵称头像信息
